 ...
 */
    pub fn hs_deserialize_database(bytes: *const ::std::os::raw::c_char,
                                   length: usize, db: *mut *mut hs_database_t)
     -> hs_error_t;
}
extern "C" {
    /**
 ...
 */
    pub fn hs_deserialize_database_at(bytes: *const ::std::os::raw::c_char,
                                      length: usize, db: *mut hs_database_t)
     -> hs_error_t;
}
extern "C" {
    /**
 ...
 */
    pub fn hs_stream_size(database: *const hs_database_t,
                          stream_size: *mut usize) -> hs_error_t;
}
extern "C" {
    /**
 ...
 */
    pub fn hs_database_size(database: *const hs_database_t,
                            database_size: *mut usize) -> hs_error_t;
}
extern "C" {
    /**
...
fn bindgen_test_layout_hs_compile_error() {
    assert_eq!(::std::mem::size_of::<hs_compile_error>() , 16usize , concat !
               ( "Size of: " , stringify ! ( hs_compile_error ) ));
    assert_eq! (::std::mem::align_of::<hs_compile_error>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( hs_compile_error ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_compile_error ) ) . message as * const
                _ as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_compile_error ) ,
                "::" , stringify ! ( message ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_compile_error ) ) . expression as *
...
fn bindgen_test_layout_hs_platform_info() {
    assert_eq!(::std::mem::size_of::<hs_platform_info>() , 32usize , concat !
               ( "Size of: " , stringify ! ( hs_platform_info ) ));
    assert_eq! (::std::mem::align_of::<hs_platform_info>() , 8usize , concat !
                ( "Alignment of " , stringify ! ( hs_platform_info ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_platform_info ) ) . tune as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_platform_info ) ,
                "::" , stringify ! ( tune ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_platform_info ) ) . cpu_features as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_platform_info ) ,
                "::" , stringify ! ( cpu_features ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_platform_info ) ) . reserved1 as *
                const _ as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_platform_info ) ,
                "::" , stringify ! ( reserved1 ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_platform_info ) ) . reserved2 as *
...
fn bindgen_test_layout_hs_expr_info() {
    assert_eq!(::std::mem::size_of::<hs_expr_info>() , 12usize , concat ! (
               "Size of: " , stringify ! ( hs_expr_info ) ));
    assert_eq! (::std::mem::align_of::<hs_expr_info>() , 4usize , concat ! (
                "Alignment of " , stringify ! ( hs_expr_info ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_expr_info ) ) . min_width as * const _
                as usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_expr_info ) , "::" ,
                stringify ! ( min_width ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_expr_info ) ) . max_width as * const _
                as usize } , 4usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_expr_info ) , "::" ,
                stringify ! ( max_width ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_expr_info ) ) . unordered_matches as *
                const _ as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_expr_info ) , "::" ,
                stringify ! ( unordered_matches ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_expr_info ) ) . matches_at_eod as *
                const _ as usize } , 9usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_expr_info ) , "::" ,
                stringify ! ( matches_at_eod ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_expr_info ) ) . matches_only_at_eod as
...
fn bindgen_test_layout_hs_expr_ext() {
    ...
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_expr_ext ) ) . flags as * const _ as
                usize } , 0usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_expr_ext ) , "::" ,
                stringify ! ( flags ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_expr_ext ) ) . min_offset as * const _
                as usize } , 8usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_expr_ext ) , "::" ,
                stringify ! ( min_offset ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_expr_ext ) ) . max_offset as * const _
                as usize } , 16usize , concat ! (
                "Alignment of field: " , stringify ! ( hs_expr_ext ) , "::" ,
                stringify ! ( max_offset ) ));
    assert_eq! (unsafe {
                & ( * ( 0 as * const hs_expr_ext ) ) . min_length as * const _
 ...
 */
    pub fn hs_scratch_size(scratch: *const hs_scratch_t,
                           scratch_size: *mut usize) -> hs_error_t;
}
extern "C" {
    /**
