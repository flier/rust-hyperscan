...
fn bindgen_test_layout_hs_compile_error() {
    assert_eq!(::std::mem::size_of::<hs_compile_error>() , 16usize);
    assert_eq!(::std::mem::align_of::<hs_compile_error>() , 8usize);
}
...
fn bindgen_test_layout_hs_platform_info() {
    assert_eq!(::std::mem::size_of::<hs_platform_info>() , 32usize);
    assert_eq!(::std::mem::align_of::<hs_platform_info>() , 8usize);
}
...
fn bindgen_test_layout_hs_expr_info() {
    assert_eq!(::std::mem::size_of::<hs_expr_info>() , 12usize);
    assert_eq!(::std::mem::align_of::<hs_expr_info>() , 4usize);
}
...
fn bindgen_test_layout_hs_expr_ext() {
    assert_eq!(::std::mem::size_of::<hs_expr_ext>() , 32usize);
    assert_eq!(::std::mem::align_of::<hs_expr_ext>() , 8usize);
}
